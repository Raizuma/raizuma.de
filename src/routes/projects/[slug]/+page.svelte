...
<div class="h-auto w-auto text-left md:mx-16">
    ...
    <div class="flex h-auto w-auto items-start justify-center">
        <div
            class="flex items-center justify-center text-center text-2xl py-5 md:w-1/2 md:text-5xl"
        >
    ...
    <div class="text-1xl mx-8 md:mx-16 lg:text-2xl">
        {#if data.projectData.developer}
            <div
                class="flex items-center justify-center text-center w-max items-start justify-center rounded-xl bg-slate-800/75 py-3"
            >
                <a
                    class="text-1xl mx-8 hover:text-sky-400/75 md:mx-16 lg:text-2xl"
                    href={data.projectData.downloadlink}>Download</a
                >
            </div>
            <div>
                <div class="flex h-auto w-auto items-start justify-center">
                    <div>
                        ...
                        Veröffentlicht: {data.projectData.date}<br />
